...
当前项目已经完成 Stage 9 收口，正在进入 Stage 10 Web Component / mount API 方案设计。Stage 10 继续遵守文档先行：先确认挂载 API、样式策略、包入口和验证 demo，再开始实现。
...
详细方案见 [stage-10-web-component.md](./stage-10-web-component.md)。
